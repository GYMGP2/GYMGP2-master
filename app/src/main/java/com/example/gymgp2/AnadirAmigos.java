...
public class AnadirAmigos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptador = new AdaptadorCuentas(this);
        ...
        btnatras6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Amigos.class);
    ...
    public void casteo(){
        listViewCustomAdapter = findViewById(R.id.listaAnadir);
        btnatras6 = (ImageView) findViewById(R.id.btnatras6);
    }

    private void listarCuentas(String email) {
        RequestQueue queue = Volley.newRequestQueue(this);
        HashMap<String, String> parametros = new HashMap<>();
        parametros.put("email", email);

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Api.EndPointListarAmigo,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < CuentaArray.length(); i++) {
                        JSONObject RowCuenta = CuentaArray.getJSONObject(i);
                        cuentas = new Cuentas(RowCuenta.getInt("codigo_usuario"),
                                RowCuenta.getString("nombres"),
                                RowCuenta.getString("apellidos"),
                                RowCuenta.getString("foto"));
    ...
    private void agregarAmigo(int codigoUsuario, int codigoAmigo) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Api.EndPointAgregarAmigo,
                new JSONObject(parametros), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Si",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    agregarAmigo(Integer.valueOf(Api.codigo_usuario),amigo);
                                    startActivity(new Intent(getApplicationContext(), AnadirAmigos.class));
                                    finish();
                                }
                            })
